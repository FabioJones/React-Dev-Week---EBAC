...
function Footer(){
    return (
        <footer className="footer">
            <div className='footer__section footer__section--frist'>
            ...
            <div className='footer__section footer__section--second'>
                <div className="footer__container">
                <p>
                    <strong>Projeto Elaborado durante a RDW <a href='https://ebaconline.com.br/'>E.B.A.C</a> 2021</strong>
                    <small>
                      Projetado por<a href='https://github.com/cavalcantemmarcelo' target="blank"> Marcelo Cavalcante</a>. e <a href='https://github.com/mja-maia/mja-maia'target="blank">Miguel Maia</a>, desenvolvido por Aluno EBAC.
                    </small> 
                </p>
